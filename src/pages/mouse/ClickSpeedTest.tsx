  ...
  const schema = {
    ...
    '@graph': [
      generateWebPageSchema(
        ...
        'Test your clicking speed with our CPS (Clicks Per Second) tester. Track your performance and improve your clicking speed.',
        'https://testmyrig.com/mouse-tools/click-speed'
      ),
      generateBreadcrumbSchema([
        { name: 'Home', url: '/' },
        { name: 'Mouse Tools', url: '/mouse-tools' },
        { name: 'Click Speed Test', url: '/mouse-tools/click-speed' }
      ])
    ]
  };

  const relatedTools = mouseToolItems.filter(tool => tool.path !== '/mouse-tools/click-speed');

  return (
    <>
      <SEO
        title="Click Speed Test - CPS Test"
        description="Test your mouse click speed (CPS - clicks per second). Find out how fast you can click in 10 seconds. Improve your CPS for gaming and other applications."
        canonical="https://testmyrig.com/mouse-tools/click-speed"
