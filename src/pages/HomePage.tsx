...
const HomePage: React.FC = () => {
  return (
    <MainLayout 
      title="RateRacer - Test Your Peripherals"
      headerTitle="Welcome to RateRacer"
      ...
      <div className="container mx-auto py-12 px-4">
        <section className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Whether you're a gamer, professional, or tech enthusiast, RateRacer provides the tools you need 
